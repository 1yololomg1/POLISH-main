...
exports.LASParserProductionExample = void 0;
exports.demonstrateProductionUsage = demonstrateProductionUsage;
const lasParser_1 = require("./lasParser");
const MnemonicStandardizer_1 = require("./MnemonicStandardizer");
const processingAlgorithms_1 = require("./processingAlgorithms");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class LASParserProductionExample {
    constructor() {
        this.parser = new lasParser_1.LASParser();
        this.standardizer = new MnemonicStandardizer_1.MnemonicStandardizer();
        this.algorithms = new processingAlgorithms_1.ProcessingAlgorithms();
    }
    /**
     ...
     */
    async batchProcessWithQualityAssessment(filePaths, options = {}) {
     ...
     */
    async enterpriseProcessingPipeline(filePath, processingOptions = {}) {
     ...
     */
    async realTimeProcessing(filePath, onProgress) {
        ...
        const standardizationResult = await this.standardizer.standardizeMnemonics(parseResult.data, { standard: 'api', autoStandardize: true, preserveOriginal: true });
     ...
     */
    async performQualityAssessment(file) {
        const assessment = {
     ...
     */
    async processData(file, options) {
        const algorithms = [];
        try {
     ...
     */
    generateQualityReport(qualityMetrics, processingTime) {
...
exports.LASParserProductionExample = LASParserProductionExample;
// Usage examples
async function demonstrateProductionUsage() {
    ...
    const realTimeResult = await example.realTimeProcessing('path/to/large_well.las', (progress, message) => console.log(`Progress: ${progress}% - ${message}`));
    console.log('Real-time processing completed:', realTimeResult.name);
}
//# sourceMappingURL=lasParserExample.js.map