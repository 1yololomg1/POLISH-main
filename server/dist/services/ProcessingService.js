...
const processingAlgorithms_1 = require("../utils/processingAlgorithms");
const MnemonicStandardizer_1 = require("../utils/MnemonicStandardizer");
const lasParser_1 = require("../utils/lasParser");
class ProcessingService {
    ...
    async processFile(fileBuffer, fileName, options, userId) {
     ...
     */
    performQualityAssessment(lasFile) {
     ...
     */
    generateRecommendations(lasFile, qualityScore) {
    ...
    generateProcessingCertificate(fileName, userId, history, initialQC, finalQC) {
        return {
    ...
    generateSignature(fileName, userId, history) {
